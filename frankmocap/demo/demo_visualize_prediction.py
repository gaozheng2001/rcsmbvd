...
from frankmocap.bodymocap.models import SMPL, SMPLX
from frankmocap.handmocap.hand_modules.h3dw_model import extract_hand_output
...
def visualize_prediction(args, demo_type, smpl_type, smpl_model, pkl_files, visualizer):
    for pkl_file in pkl_files:
        ...
        if img_original_bgr is None or img_original_bgr.size == 0:
...
def main():
    ...
    args.pkl_dir = 'mocap_output/mocap'
    args.renderer_type  = 'opendr'
