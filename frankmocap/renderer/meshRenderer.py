...
from frankmocap.renderer.shaders.framework import *

from frankmocap.renderer.glRenderer import glRenderer
...
class meshRenderer(glRenderer):
    ...
    def __init__(self, width=1600, height=1200, name='GL Renderer',
                #  program_files=['frankmocap/renderer/shaders/simple140.fs', 'frankmocap/renderer/shaders/simple140.vs'],
                #  program_files=['frankmocap/renderer/shaders/normal140.fs', 'frankmocap/renderer/shaders/normal140.vs'],
                # program_files=['frankmocap/renderer/shaders/geo140.fs', 'frankmocap/renderer/shaders/geo140.vs'],
                render_mode ="normal",  #color, geo, normal
                color_size=1, ms_rate=1):

        self.render_mode = render_mode
        self.program_files ={}
        self.program_files['color'] = ['frankmocap/renderer/shaders/simple140.fs', 'frankmocap/renderer/shaders/simple140.vs']
        self.program_files['normal'] = ['frankmocap/renderer/shaders/normal140.fs', 'frankmocap/renderer/shaders/normal140.vs']
        self.program_files['geo'] = ['frankmocap/renderer/shaders/colorgeo140.fs', 'frankmocap/renderer/shaders/colorgeo140.vs']
